...
private:
	...
	const int input_shape[2] = { 512, 512 };   //// height, width
...
{
	cout << "start" << endl;
	yolox net("yolox_s_512.onnx", 0.6, 0.6);
	string imgpath = "image/000099.bmp";  ///输入图片的路径，你也可以改成外部传参argv的方式，或者是读取视频文件
	...
	*/
	...
	cvtColor(srcimg, cimg, COLOR_BGR2GRAY);
	...
	HoughCircles(cimg, circles, HOUGH_GRADIENT, 1, 1000, 80, 25, 100, 9000);
	...
	for (size_t i = 0; i < circles.size(); i++)
	{
		...
		//绘制圆轮廓  
		circle(srcimg, center, radius, Scalar(0, 0, 255));
